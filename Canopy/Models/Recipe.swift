...
struct Recipe: Identifiable{
    ...
    init(){ // second initializer for making empty recipes that the user can edit
...
struct Ingredient: RecipeComponent{
    ...
    var description: String{
        let formattedQuantity = String(format: "%g", quantity) // makes number more readable by removing trailing zeroes using "%g" formatter
        switch unit{
            case .none:
...
// Testing recipe objects from codecademy
